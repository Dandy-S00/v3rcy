...
const mocks = vi.hoisted(() => ({ updateProfileMedia: vi.fn(), getMyProfile: vi.fn().mockResolvedValue({ accountStatus: "active" }) }));
vi.mock("./db", () => ({ updateProfileMedia: mocks.updateProfileMedia, getMyProfile: mocks.getMyProfile }));

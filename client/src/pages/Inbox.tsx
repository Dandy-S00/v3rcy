...
export default function Inbox() {
  ...
  const handleSendMessage = () => {
    if (recipientId && draft.trim() && !send.isPending) {
      send.mutate({ recipientUserId: recipientId, body: draft });
    }
  };
